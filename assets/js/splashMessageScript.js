document.addEventListener("DOMContentLoaded", function() {
  const splashMessages = [
    ...
    "Dismiss those who deride you solely for being smart.",
    "God may not play dice with the universe, but something strange is going on with the prime numbers.",
    "My brain is open.",
    "You weep like a woman for a kingdom you could not defend like a man.",
    ...
    "Every girl is a 10 with clown makeup on.",
    "AVR1H.COM",
    ...
    "🔒THIS SPLASH TEXT IS LOCKED - DONATION REQUIRED TO UNLOCK🔒",
    "the sense of dread is back",
    "Existential dread central.",
    "Peaked in the womb.",
    "Life's a circus, and I'm the clown.",
    "You are not a clown. You are the entire circus.",
    "I got 99 problems, and overthinking is all of them.",
